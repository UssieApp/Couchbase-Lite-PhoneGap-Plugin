...
This fork is to experiment with building a database-direct cordova build for CBLite, rather than using the Listener. You're probably looking for [the official repository](https://github.com/couchbaselabs/Couchbase-Lite-PhoneGap-Plugin).

If you are still reading, are open to contributions to this endeavor!
